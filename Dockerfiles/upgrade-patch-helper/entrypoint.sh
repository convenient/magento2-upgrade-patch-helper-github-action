...
run_patch_helper() {
    ...
    php -d memory_limit=2G /patch-helper/ampersand-magento2-upgrade-patch-helper-master/bin/patch-helper.php analyse --show-info --sort-by-type . | tee ./patch-helper-output.txt
